...
const ChatMessage: React.FC<ChatMessageProps> = ({ type, content }) => {
  ...
  const containerClasses = isAssistant
    ? "flex p-5 rounded-xl almond-green bg-opacity-20 max-md:p-1 max-md:rounded-lg"
    : "flex p-5 rounded-xl max-md:p-1 max-md:rounded-lg";
    ...
    <div className={containerClasses}>
      {isAssistant && (
        <img
          ...
          src={iconSrc}
          alt="Assistant icon"
          className="shrink-0 w-5 aspect-square m-1 max-md:m-0.5 max-md:w-3 self-start"
        />
      )}
      <div
